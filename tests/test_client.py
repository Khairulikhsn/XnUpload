...
from xnup.client import Client, parse_proxy_string, phone_match
from xnup.exceptions import TelegramUploadDataLoss, TelegramUploadNoSpaceError, TelegramProxyError, \
    MissingFileError
from xnup.files import File
...
class TestClient(unittest.TestCase):
    ...
    @patch('xnup.client.TelegramClient.__init__')
    ...
    def test_no_space_error(self):
        ...
        with patch('xnup.client.free_disk_usage', return_value=0), \
