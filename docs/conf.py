...
copyright = u"%i, Khairulikhsn Com" % datetime.date.today().year

pdf_documents = [('index', u'rst2pdf', u'Telegram Upload', u'Khairulikhsn'), ]

rinoh_documents = [('index',            # top-level file (index.rst)
                    'target',           # output (target.pdf)
                    'Telegram Upload',   # document title
                    'Khairulikhsn')]   # document author
